     ...
     <tr><th>제목</th>
      ...
      <tr><th>내용</th>
          <td><textarea name='content'  class="form-control"
           rows='5' cols='50'>${board.content }</textarea>
          </td></tr>
      <tr><th>암호</th>
         <td>
          <input type='password' name='password'  class="form-control" value='${board.password }'>
          </td></tr>
      <tr><th>조회수</th><td>${board.viewCount }</td></tr>
      <tr><th>등록일</th><td>${board.createDate }</td></tr>
      <tr><th>첨부파일</th>
          <td><a href='../files/${board.attachFile1 }'>${board.attachFile1 }</a>
